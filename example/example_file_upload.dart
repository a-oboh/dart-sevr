...
// final file2 = File(req.files['lolag3']['filename']);
// req.files['lolag']['buffer'].stream.listen( (data){
// print(data);
// });
main() {
  var serv = Sevr();
  serv.get('/test', [
    (req, res) async {
      for (int i = 0; i < req.files.keys.length; i++) {
        //Handle your file stream as you ssee fit, write to file, pipe to a cdn etc --->
